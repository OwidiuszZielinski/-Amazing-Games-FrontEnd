          ...
          <v-card class="elevation-12">
            ...
            <v-card-text>
              <form @submit.prevent="handleSubmit">
                <v-text-field color="#272727" v-model="username" name="login" :rules="loginRules" label="Login" type="text"
                   required></v-text-field>

                <v-text-field v-model="password" name="password" label="Password" :rules="passwordRules"  type="password" 
                  required></v-text-field>
