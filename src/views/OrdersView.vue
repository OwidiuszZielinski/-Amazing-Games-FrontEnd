          ...
          <v-card>
              ...
              <v-container>
                <v-row>
                  <v-col cols="12" sm="6" md="6">
                    <v-text-field v-model="newOrder.status" label="status"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="6">
                    <v-text-field v-model="newOrder.user" label="user"></v-text-field>
                  </v-col>
                  <v-col>
            ...
            <v-card-actions>
              ...
              <v-btn class="btn btn-primary" color="blue darken-1" text
                v-on:click="newOrder.games = newOrderGames" @click="save">
